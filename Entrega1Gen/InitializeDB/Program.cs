...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: Entrega1GenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("Entrega1GenNHibernate", "nhibernateUser", "nhibernatePass");
