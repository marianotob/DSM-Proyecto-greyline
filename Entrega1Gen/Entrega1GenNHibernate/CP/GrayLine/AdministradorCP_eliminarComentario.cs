...
/*PROTECTED REGION ID(usingEntrega1GenNHibernate.CP.GrayLine_Administrador_eliminarComentario) ENABLED START*/
...
{
public void EliminarComentario (string p_Administrador_OID)
{
        /*PROTECTED REGION ID(Entrega1GenNHibernate.CP.GrayLine_Administrador_eliminarComentario) ENABLED START*/
        ...
        try
        {
                ...
                administradorCAD.EliminarComentario (administradorEN);
